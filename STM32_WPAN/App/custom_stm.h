...
{
  /* CM200_UART_WRITE */
  CUSTOM_STM_WRITE_READ_EVT,
  CUSTOM_STM_WRITE_WRITE_NO_RESP_EVT,
  /* CM200_UART_READ */
  CUSTOM_STM_READ_READ_EVT,
  CUSTOM_STM_READ_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_READ_NOTIFY_DISABLED_EVT,
...
/* Exported constants --------------------------------------------------------*/
extern uint8_t SizeWrite;
extern uint8_t SizeRead;
